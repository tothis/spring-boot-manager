...
public class ResponseHandler implements ResponseBodyAdvice<Object> {
     ...
     */
    @Override
    public boolean supports(final MethodParameter methodParameter, Class<? extends HttpMessageConverter<?>> aClass) {
     ...
     */
    @Override
    public Object beforeBodyWrite(final Object o, final MethodParameter parameter, final MediaType type
        , final Class<? extends HttpMessageConverter<?>> aClass
        , ServerHttpRequest request, ServerHttpResponse response) {
        return o instanceof Result ? o : Result.ok(o);
    }
}
